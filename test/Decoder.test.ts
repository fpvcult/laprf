...
const STATUS_RECORD_STRING = '5a610043c50ada21022d10230101240400000000010101220400404f44010102220400804f44010103220400000000010104220400000000010105220400000000010106220400000000010107220400000000010108220400000000030200005b'; // prettier-ignore
const TIME_RECORD_STRING = '5a1c00d52b0cda02086051fcaf01000000200800000000000000005b'; // prettier-ignore
...
const STATUS_RECORD = convert(toBytes(STATUS_RECORD_STRING), DataView);
const TIME_RECORD = convert(toBytes(TIME_RECORD_STRING), DataView);
